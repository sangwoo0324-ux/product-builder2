...
import { GoogleGenerativeAI } from 'https://cdn.jsdelivr.net/npm/@google/genai@latest/dist/index.min.js'; // Added import
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (genAIInstance) {
        ...
        console.error("Gemini API instance could not be created.");
    }
